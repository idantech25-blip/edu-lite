...
import 'package:ann/welcome_tour_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  void _onLoginPressed() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => WelcomeTourScreen(displayName: _emailController.text.trim()),
        ),
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? Colors.black : const Color(0xff92d6e8),
      appBar: AppBar(
        elevation: 0,
        backgroundColor: isDark ? Colors.black : const Color(0xff92d6e8),
        leading: IconButton(
                    ...
                    children: [
                      ...
                      FadeTransition(
                        ...
                        child: PasswordField(
                          ...
                          onVisibilityToggle: () => setState(() => _isObscured = !_isObscured),
                      ...
                      FadeTransition(
                        ...
                        child: Row(
                          ...
                          children: [
                            const Text("Don't have an account yet?", style: TextStyle(color: Colors.black87, fontSize: 17)),
                            TextButton(
...
class PasswordField extends StatelessWidget {
  const PasswordField({required this.controller, required this.isObscured, required this.onVisibilityToggle, this.focusNode});
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        suffixIcon: IconButton(
          icon: Icon(isObscured ? Icons.visibility_off : Icons.visibility, color: isDark ? Colors.white70 : Colors.black54),
